        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                ...
                <li class="item" id="profile">
                    ...
                    <div class="sub-menu">
                        <a href="addHr.html"><i class="fas fa-image"></i><span>ADD HR</span></a>
                        <a href="delete.html"><i class="fas fa-address-card"></i><span>DELETE HR</span></a>
                    </div>
                </li>
                <li class="item" id="messages">
                    ...
                    <div class="sub-menu">
                        <a href="viewHr.jsp"><i class="fas fa-envelope"></i><span>VIEW HR'S</span></a>
...
<tr>
<th><font color="black"size="5">ID</font></th>
<th><font color="black"size="5">Name</font></th>
<th><font color="black"size="5">Email</font></th>
<th><font color="black"size="5">Mobile No</font></th>
<th><font color="black"size="5">PASSWORD</font></th>
<th><font color="black"size="5">DESIGNATION</font></th>
...
<TD><font color="black"size="5"><%= rs.getLong(4) %></font></TD>
